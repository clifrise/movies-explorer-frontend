    ...
    <section id="student" className="student">
      ...
      <div className="student__content">
        ...
        <p className="student__description">
          В 2010 году закончил ВоГТУ. С нуля делаю сайты и сервисы
          интернет-платежей, помогаю найти и исправить технические ошибки в
          работающих проектах. Консультирую по продвижению сайтов в поисковых
          системах. Умею запускать большие проекты: в 2010 году вместе с
          командой разработал и запустил интернет-банк Сбербанка России. В 2012
          запустил сайт платежной системы Rapida. В 2020 году запустил сайт
          «Бизнес Секреты» от Тинькофф Банка.
        </p>
